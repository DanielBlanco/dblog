...
var _user$project$Post$view = function (model) {
	return A2(
					...
					{ctor: '[]'},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(
								_elm_lang$core$Basics_ops['++'],
								' (published at: ',
								A2(_elm_lang$core$Basics_ops['++'], model.publishedAt, ')'))),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Post$Model = F2(
	function (a, b) {
		return {title: a, publishedAt: b};
	});
...
var _user$project$Main$initialModel = {postListModel: _user$project$Components_PostList$initialModel};
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Main$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Main$Model = function (a) {
	return {postListModel: a};
};
var _user$project$Main$PostListMsg = function (a) {
	return {ctor: 'PostListMsg', _0: a};
};
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		var _p1 = A2(_user$project$Components_PostList$update, _p0._0, model.postListModel);
		...
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{postListModel: updatedModel}),
			_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$PostListMsg, cmd)
		};
	});
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				_user$project$Main$PostListMsg,
				_user$project$Components_PostList$view(model.postListModel)),
			_1: {ctor: '[]'}
		});
};
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Components.PostList.Msg":{"args":[],"tags":{"GetPosts":[],"PostsResponse":["Components.PostList.WebPosts"],"NoOp":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"RemoteData.RemoteData":{"args":["e","a"],"tags":{"NotAsked":[],"Success":["a"],"Loading":[],"Failure":["e"]}},"Main.Msg":{"args":[],"tags":{"PostListMsg":["Components.PostList.Msg"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}}},"aliases":{"RemoteData.WebData":{"args":["a"],"type":"RemoteData.RemoteData Http.Error a"},"Components.PostList.WebPosts":{"args":[],"type":"RemoteData.WebData Components.PostList.Posts"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Post.Model":{"args":[],"type":"{ title : String, publishedAt : String }"},"Components.PostList.Posts":{"args":[],"type":"List Post.Model"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
